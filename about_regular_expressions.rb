...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # When would * fail to match?
      # When the character preceding isn't present anywhere in the string
  end
  ...
  #
  # Why?
    # Because they take (...or match, really) anything they can get.
    # You could also argue that they're benevolent: they give characters the
