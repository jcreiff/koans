...
class AboutSymbols < Neo::Koan
  ...
  # against the string value rather than against symbols?
    # Every time you run a line with a new symbol, a new space in memory is created
    # for that symbol, so any assertion about the existence of a symbol will be true.
